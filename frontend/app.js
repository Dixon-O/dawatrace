  ...
  landing: function() {
    return '<section class="hero">' +
      '<div class="container">' +
        ...
        '<p class="hero-subtitle">DawaTrace uses blockchain provenance and algorithmic risk scoring to combat counterfeit pharmaceuticals — the silent crisis killing over 1 million people annually. Scan any medicine, from any country, in seconds.</p>' +
