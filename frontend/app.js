...
const CONTRACT_ABI = [
  ...
  "function verifyDrug(bytes32) returns (tuple(bool,string,string,string,uint256,uint256,bool,uint256))",
  "function verifyDrugView(bytes32) view returns (tuple(bool,string,string,string,uint256,uint256,bool,uint256))",
  "function reportCounterfeit(bytes32,string)",
  "function getCustodyChain(bytes32) view returns (tuple(address,address,uint256,string,uint8,uint8)[])",
